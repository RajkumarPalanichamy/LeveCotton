        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-6 mb-6">
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 mb-6">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-6 py-3 rounded-lg transition-all duration-200 shadow-md hover:shadow-lg font-bold bg-gradient-to-r from-green-600 to-teal-600 hover:from-green-700 hover:to-teal-700 text-white"
              >
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            ...
            <div className="bg-gradient-to-br from-amber-50 to-amber-100 p-4 rounded-lg border border-amber-200">
              <p className="text-sm text-amber-700 font-semibold">Sold out</p>
                ...
                <div className="relative h-64 bg-gray-100 overflow-hidden shrink-0">
                  ...
                  {product.inStock === false && (
                    <div className="absolute inset-0 z-[5] flex items-center justify-center bg-black/50">
                      <span className="rounded-full bg-white/95 px-3 py-1 text-xs font-bold uppercase tracking-wide text-gray-900 shadow-md">
                        Sold out
                      </span>
                    </div>
                  )}
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center justify-between mb-3">
                      ...
                      <div className="flex flex-wrap items-center justify-end gap-1">
                        {product.inStock === false && (
                          <span className="text-[10px] uppercase tracking-wider bg-amber-100 text-amber-900 px-2 py-1 rounded-full border border-amber-200 font-bold">
                            Sold out
                          </span>
                        )}
                        {product.color && (
                ...
                <label className="flex cursor-pointer items-start gap-3">
                  ...
                  <span>
                    ...
                    <span className="mt-1 block text-xs text-gray-600">
                      Uncheck to mark as sold out. Sold-out items cannot be added to cart or purchased online.
                    </span>
                  </span>
                </label>
              </div>
