    ...
    <div className="min-h-screen bg-white" style={{ backgroundColor: 'white' }}>
      ...
      >
        <div className="container mx-auto px-4">
          ...
          <div
            className="max-w-4xl mx-auto overflow-hidden rounded-lg shadow-sm border"
            style={{ borderColor: '#E5D5C8' }}
          >
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d5659.020489381024!2d77.7232776!3d11.341565099999999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ba96fad4a035f89%3A0x172e34d37504bcea!2sLEVE%20Cottons!5e1!3m2!1sen!2sin!4v1775125106853!5m2!1sen!2sin"
              width={600}
              height={450}
              className="w-full h-[280px] sm:h-[360px] md:h-[450px] border-0"
              allowFullScreen
              loading="lazy"
              referrerPolicy="no-referrer-when-downgrade"
              title="LEVE Cottons on Google Maps"
            />
          </div>
        </div>
      </section>
